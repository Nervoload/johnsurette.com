...
// node_modules/@react-three/fiber/dist/index-af244448.esm.js
...
function setDeep(obj, value, keys) {
  const key = keys.pop();
  const target = keys.reduce((acc, key2) => acc[key2], obj);
...
function createLoop(roots2) {
  ...
  function loop(timestamp) {
    ...
    if (globalAfterEffects.size)
      run(globalAfterEffects, timestamp);
    if (repeat === 0) {
      if (globalTailEffects.size)
...
var Canvas = React2.forwardRef(function Canvas2({
  children,
  fallback,
  resize,
  style,
  ...
  if (containerRect.width > 0 && containerRect.height > 0 && canvas) {
    ...
    root.current.render(React2.createElement(ErrorBoundary, {
      set: setError
    }, React2.createElement(React2.Suspense, {
      fallback: React2.createElement(Block, {
        set: setBlock
      })
    }, children)));
  }
  ...
  }, props), React2.createElement("div", {
    ref: containerRef,
    style: {
      width: "100%",
      height: "100%"
    }
  }, React2.createElement("canvas", {
    ref: canvasRef,
    style: {
      display: "block"
    }
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-I7G2JDJB.js.map
