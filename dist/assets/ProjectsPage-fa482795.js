import{a as l,aE as Mt,aF as wt,aG as vt,j as t,aA as bt,aB as jt,I as nt,ah as kt,n as it,aH as st,C as de,aI as St,aJ as Rt,Y as Pt,o as J,az as Oe,aK as $t,R as rt,M as E,V as q,a4 as Ct,W as Et,a2 as At,aL as It,aM as Lt,aN as Ye,A as Tt,m as Fe,p as Nt,h as Dt,aO as Ue}from"./index-040fea6e.js";import{D as Gt,L as zt}from"./LandingOnboardingOverlay-007db784.js";import{S as Bt}from"./SceneBloom-77a445fe.js";import{c as je}from"./probe-e4e617c0.js";import{a as Ot,u as Yt}from"./use-motion-value-e38ada22.js";import{u as Ft}from"./use-motion-value-event-14896ed5.js";import{P as Ut}from"./PageScaffold-02ef299d.js";import"./Footer-4bc4c10a.js";function Zt(e){const s=l.useRef(0),{isStatic:r}=l.useContext(Mt);l.useEffect(()=>{if(r)return;const i=({timestamp:a,delta:n})=>{s.current||(s.current=a),e(a-s.current,n)};return wt.update(i,!0),()=>vt(i)},[e])}const Ht=({progress:e,height:s=200,forceLowPower:r=!1,themeMode:i,children:a})=>{const[n,c]=l.useState(!1),[p,d]=l.useState(!1);l.useEffect(()=>{if(typeof window>"u")return;const f=window.matchMedia("(max-width: 900px)"),h=window.matchMedia("(prefers-reduced-motion: reduce)"),x=()=>{c(f.matches),d(h.matches)};return x(),f.addEventListener?(f.addEventListener("change",x),h.addEventListener("change",x)):(f.addListener(x),h.addListener(x)),()=>{f.removeEventListener?(f.removeEventListener("change",x),h.removeEventListener("change",x)):(f.removeListener(x),h.removeListener(x))}},[]);const o=p||r,u=s,m=l.useMemo(()=>i==="dark"?"#0b1326":"#eef4fb",[i]);return l.useEffect(()=>{},[o,n,u,i]),t.jsx("section",{style:{height:`${u}vh`},className:"relative",children:t.jsxs("div",{className:"sticky top-0 h-[100svh] overflow-hidden",children:[t.jsx("div",{className:"theme-project-scene-haze-a pointer-events-none absolute inset-0"}),t.jsx("div",{className:"theme-project-scene-haze-b pointer-events-none absolute inset-0"}),t.jsx(bt,{children:t.jsxs(jt,{className:"absolute inset-0 h-full w-full",camera:{position:[0,.14,6.15],fov:43},dpr:o?[1,1.5]:[1,2],shadows:!1,gl:{preserveDrawingBuffer:!1,antialias:!o,powerPreference:"high-performance",alpha:!0},onCreated:({gl:f})=>{f.outputColorSpace=nt,kt.enabled=!0,f.shadowMap.enabled=!1,f.setClearColor(16777215,0)},children:[t.jsx("fog",{attach:"fog",args:[m,8,24]}),t.jsx("ambientLight",{intensity:.72}),t.jsx("spotLight",{position:[0,5.2,2.6],angle:.56,penumbra:.66,intensity:o?1.45:1.68,distance:26}),t.jsx("directionalLight",{position:[2.8,2.6,2.4],intensity:.45}),t.jsx("directionalLight",{position:[-3.2,1.4,-2.8],intensity:.18}),t.jsx(Bt,{enabled:!o}),t.jsx("group",{scale:1.14,position:[0,.02,0],children:a(e,{lowPowerMode:o,mobileViewport:n})})]})}),t.jsx("div",{className:"theme-project-scene-bottom-fade pointer-events-none absolute inset-x-0 bottom-0 h-36"})]})})},_t=e=>"data:image/svg+xml;utf8,"+encodeURIComponent(e==="dark"?"<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 720 1024'><rect width='720' height='1024' fill='#0f172a'/><rect x='36' y='36' width='648' height='952' rx='28' fill='none' stroke='#334155' stroke-width='8'/></svg>":"<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 720 1024'><rect width='720' height='1024' fill='#f8fafc'/><rect x='36' y='36' width='648' height='952' rx='28' fill='none' stroke='#94a3b8' stroke-width='8'/></svg>"),Vt="data:image/svg+xml;utf8,"+encodeURIComponent("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 720 1024'><defs><linearGradient id='g' x1='0' y1='0' x2='1' y2='1'><stop offset='0%' stop-color='#103a8a'/><stop offset='100%' stop-color='#1f5fd8'/></linearGradient></defs><rect width='720' height='1024' fill='url(#g)'/></svg>"),ct=l.forwardRef(({frontSrc:e,backSrc:s,width:r,height:i,thickness:a=.02,borderColor:n="#e0e0e0",edgeColor:c,edgeGlow:p,flip:d,pop:o,popScale:u=1.15,onClick:m,isClickable:f,frontAttachment:h,themeMode:x="light",...w},v)=>{const{viewport:L,gl:$}=it(),me=Math.min(L.width,L.height),A=r??me*.08,T=i??A*1.4,F=l.useRef(null),ee=l.useRef(null),xe=l.useRef(null),R=l.useRef(null),ge=l.useRef(null),ye=l.useRef(null),ne=l.useRef(!1);l.useImperativeHandle(v,()=>F.current,[]);const U=st(rt,e??_t(x)),C=st(rt,s??Vt),y=l.useMemo(()=>new de(c??n),[c,n]),S=l.useMemo(()=>{const M=new St(A+.016,T+.016,a+.012),I=new Rt(M);return M.dispose(),I},[A,T,a]);l.useMemo(()=>{const M=$.capabilities.getMaxAnisotropy();for(const I of[U,C])I.colorSpace=nt,I.anisotropy=M,I.minFilter=Pt,I.needsUpdate=!0},[U,C,$]),J(()=>{var te,le,V;const M=F.current;if(!M)return;const I=((te=d==null?void 0:d.get)==null?void 0:te.call(d))??0;M.rotation.y=Math.PI*I;const Me=((le=o==null?void 0:o.get)==null?void 0:le.call(o))??0,B=1+(u-1)*Me;M.scale.setScalar(B);const ke=((V=p==null?void 0:p.get)==null?void 0:V.call(p))??0,Z=ne.current?2.15:1,G=E.clamp(ke*Z,0,1.9),ie=ee.current;ie&&(ie.emissive.setRGB(1,1,1),ie.emissiveIntensity=.24+G*.2);const ce=xe.current;ce&&(ce.uniforms.uAccentColor.value.copy(y),ce.uniforms.uGlow.value=E.clamp(G*.52,0,1.1));const we=R.current;we&&(we.opacity=E.clamp(.34+G*.22,.34,.76));const H=ge.current;H&&(H.opacity=E.clamp(G*.64,0,.95),H.color.copy(y).multiplyScalar(.95+G*2.3),H.visible=H.opacity>.01);const _=ye.current;_&&(_.uniforms.uColor.value.copy(y),_.uniforms.uOpacity.value=E.clamp(G*.28,0,.48),_.uniforms.uStrength.value=.85+G*1.7,_.visible=G>.01)}),l.useEffect(()=>()=>{$.domElement.style.cursor="auto"},[$]),l.useEffect(()=>()=>{S.dispose()},[S]);const N=()=>f?f():!0,b=M=>{ne.current=!0,m&&N()?(M.stopPropagation(),$.domElement.style.cursor="pointer"):$.domElement.style.cursor="auto"},j=()=>{ne.current=!1,$.domElement.style.cursor="auto"},g=M=>{!m||!N()||(M.stopPropagation(),m())};return t.jsxs("group",{ref:F,...w,children:[t.jsxs("mesh",{renderOrder:2,children:[t.jsx("boxGeometry",{args:[A+.03,T+.03,a+.04]}),t.jsx("shaderMaterial",{ref:ye,uniforms:{uColor:{value:y.clone()},uOpacity:{value:0},uStrength:{value:.7}},vertexShader:`
  ...
  <g>
    <rect width='${Ve}' height='${We}' fill='url(#bg)'/>
    <rect width='${Ve}' height='${We}' fill='url(#grid)'/>
  ...
  ${v}
</svg>`;return`data:image/svg+xml;utf8,${encodeURIComponent(L)}`},as=(e,s)=>{const r=e.palette,i=`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 720 1024'>
  <defs>
