import{ad as F,ab as O,aj as E,aO as Q,aP as v,aQ as _,B as c,aR as x,H as C,aS as k,aT as W,C as w,V as S,az as N,a9 as I,n as j,a as b,aU as z,aV as K,aW as G,aX as X,o as Y}from"./index-D7UpT4CE.js";const V={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}T.BlurDirectionX=new c(1,0);T.BlurDirectionY=new c(0,1);const ie=({enabled:m=!0,strength:e=.32,radius:s=.72,threshold:i=.88})=>{const{gl:r,scene:t,camera:l,size:n}=j(),u=b.useRef(!1),o=b.useMemo(()=>{try{const h=r.getPixelRatio(),a=Math.max(1,Math.floor(n.width*h)),f=Math.max(1,Math.floor(n.height*h)),d=new x(a,f,{format:z,type:C,depthBuffer:!0,stencilBuffer:!1}),g=new x(a,f,{format:z,type:C,depthBuffer:!0,stencilBuffer:!1}),p=new $(r,g);p.renderToScreen=!1;const M=new ee(t,l);M.clear=!0,M.clearAlpha=0,p.addPass(M);const y=new T(new c(a,f),e,s,i);p.addPass(y);const P=new v({uniforms:{tBase:{value:d.texture},tBloomCombined:{value:p.readBuffer.texture}},vertexShader:`
          varying vec2 vUv;
