  ...
  photos: [
    {
      ...
      src: "/images/landing/velocity.jpg",
      alt: "john and andrew at velocity 2023",
      caption: "Cornerstone Velocity 2023, Waterloo, ON.",
      palette: ["#0f172a", "#06b6d4", "#f8fafc"],
    },
    {
      id: "portrait-campus",
      src: "/images/landing/labboy.JPEG",
      alt: "john in the lab looking into a microscope",
      caption: "In the genetics lab at the University of Ottawa.",
      palette: ["#111827", "#818cf8", "#e2e8f0"],
    },
    {
      id: "portrait-builder",
      src: "/images/landing/formal.JPG",
      alt: "john in a formal setting",
      caption: "At SSA Formal 2026",
...
export const landingAspirationSectionContent: LandingAspirationSectionContent = defineLandingAspirationSection({
  ...
  overlayBeats: [
    ...
    {
      id: "graduation",
      text: "What do I aspire to build in the future?",
    },
  ],
  nodes: [
    ...
    { id: "brain-computer-interface", label: "Brain Computer Interfaces", stage: 4, lane: "left" },
