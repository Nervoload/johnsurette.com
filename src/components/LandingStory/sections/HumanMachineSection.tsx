...
const HumanMachineSection: React.FC<HumanMachineSectionProps> = ({ section }) => {
  ...
  return (
    <section className="relative isolate min-h-[100dvh] overflow-hidden px-4 py-24 xs:px-6 sm:px-10 lg:px-16">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_14%_16%,rgba(14,165,233,0.18),rgba(15,23,42,0)_44%),radial-gradient(circle_at_88%_88%,rgba(45,212,191,0.14),rgba(15,23,42,0)_42%)]" />
      ...
      <div className="relative mx-auto w-full max-w-7xl">
        ...
        <div className="mt-12 grid auto-rows-[170px] gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <motion.article
            className="theme-story-contrast-panel relative overflow-hidden rounded-2xl border p-5 sm:col-span-2 sm:row-span-2"
          ...
          >
            ...
            <h3 className="theme-story-contrast-accent relative text-xl font-semibold">Augmentation Principle</h3>
            <p className="theme-story-contrast-body relative mt-3 max-w-md text-sm leading-relaxed">
          ...
          {cards.map((item, idx) => (
            <motion.article
              key={item}
              className="theme-story-contrast-panel-soft relative overflow-hidden rounded-2xl border p-4"
            ...
            >
              ...
              <h4 className="theme-story-contrast-title relative text-sm font-semibold uppercase tracking-[0.12em]">{item}</h4>
              <p className="theme-story-contrast-body relative mt-2 text-xs leading-relaxed">
